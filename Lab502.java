...
public class Lab502 {
    public static void main(String[] args) {
        ...
        int confirm = (JOptionPane.showConfirmDialog(null, "Do you want to check your score?",
    ...
    public static int input_score(String message, int limit_score) {
        ...
        while (score < 0 || score > limit_score) {
            ...
            score = Integer.parseInt(JOptionPane.showInputDialog(null, "Score must be in range between " + limit_score +
                    "\n" + message));
